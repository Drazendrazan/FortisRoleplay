...
QBConfig.Server.closedReason = "🔸 Er is op dit moment onderhoud gaande... Join de Discord voor meer informatie: https://fortisroleplay.nl/discord" -- Reason message to display when people can't join the server
QBConfig.Server.uptime = 0 -- Time the server has been up.
QBConfig.Server.whitelist = false -- Enable or disable whitelist on the server
QBConfig.Server.discord = "fortisroleplay.nl/discord" -- Discord invite link
