...
if GetConvar('voice_useNativeAudio', 'false') == 'true' then
	...
	Cfg.voiceModes = {
		{1.5, "Fluisteren"}, -- Whisper speech distance in gta distance units
		{3.0, "Praten"}, -- Normal speech distance in gta distance units
		{8.0, "Schreeuwen"} -- Shout speech distance in gta distance units
	}
else
	Cfg.voiceModes = {
		{1.5, "Fluisteren"}, -- Whisper speech distance in gta distance units
