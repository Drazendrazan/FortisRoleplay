...
Config.ArmoryWhitelist = {
    "FPN64212", -- Pol Declercq
    "AUU63450", -- Henk elarabi
    "XQB63312", -- Vbrobin
    "MWS37897", -- Huub
}
...
Config.Vehicles = {
    ...
    ["paudi"] = "Audi A6",
    ["pamarok"] = "Volkswagen Amarok (Off-road)",
    ["pt5"] = "Volkswagen T5",
    ["pt6"] = "Volkswagen T6",
    ["pfosprinter"] = "Mercedes-Benz Sprinter (FO)",
    ["pyamahamotor"] = "Yamaha Motor (Off-road)",
    ["pbmwmotor2"] = "BMW Motor",
    ["pschafter"] = "Unmarked Schafter",
    ["poracle"] = "Unmarked Oracle",
    ["dsimerc"] = "Mercedes S350 (DSI)",
    ["dsivito"] = "Mercedes Vito (Recherche/DSI)",
    ["dsiq5"] = "Audi Q5 (DSI)",
    ["pbmw530d"] = "Unmarked BMW",
    ["popeltr"] = "Opel Technische Recherche",
    ["pvitotourer"] = "Vito Tourer",
    ["pvolvov70"] = "Volvo v70",
    ["pvwpolo"] = "Volkswagen Polo unmarked",
    ["paa4"] = "Audi a4 (DSI)",
    ["paa4unm"] = "Audi A4 Avant",
    ["pbearcat"] = "Bearcat (DSI)",
    ["pbmwmotorunm"] = "Bmw unmarked motor",
