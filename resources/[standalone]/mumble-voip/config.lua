...
mumbleConfig = {
	...
	voiceModes = {
		{2.5, "Fluisteren"}, -- Whisper speech distance in gta distance units
		{8.0, "Praten"}, -- Normal speech distance in gta distance units
		{15.0, "Schreeuwen"}, -- Shout speech distance in gta distance units
	},
