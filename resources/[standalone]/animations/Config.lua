...
-- NOte this might cause an issue of the image getting stuck on peoples screens
	...
	MenuImage = "https://i.imgur.com/Fn2VkYa.png",
...
Config.Languages = {
  ['en'] = {
        ...
        ['favoriteinfo'] = "Selecteer een animatie en maak hem favoriet.",
        ['rfavorite'] = "Reset favoriet",
        ['prop2info'] = "❓ Object animaties kunnen onderaan staan.",
        ['set'] = "Stel (",
        ['setboundemote'] = ") in als je gebinde animatie?",
        ['newsetemote'] = "~w~ is nu gebind aan ~g~CapsLock~w~.",
        ['cancelemote'] = "Stop animatie",
        ['cancelemoteinfo'] = "~r~X~w~ Stopt de animatie",
        ['walkingstyles'] = "Loop stijlen",
        ['resetdef'] = "RESET",
        ...
        ['nocancel'] = "Geen emote om te cancellen.",
        ['maleonly'] = "Deze emote is alleen voor mannen, bruh",
        ['emotemenucmd'] = "Doe /emotemenu for het menu.",
        ...
        ['camera'] = "Druk op ~y~G~w~ om de flits te gebruiken.",
        ['makeitrain'] = "Druk op ~y~G~w~ om het te laten regenen met geld.",
        ['pee'] = "Hou ~y~G~w~ ingedrukt om te plassen.",
        ['spraychamp'] = "Hou ~y~G~w~ ingedrukt om met champagne te spuiten.",
        ['bound'] = "Bound ",
        ['to'] = "to",
