...
Config.Locations = {
    ...
    ["incheckPlekken"] = {
        [1] = {x = 309.08, y = -592.91, z = 43.28},
        [2] = {x = -256.63, y = 6329.39, z = 32.40},
        [3] = {x  = 1831.21, y = 3675.38, z = 34.27},
    },
    ["duty"] = {
        [1] = {x = 304.27, y = -600.33, z = 43.28, h = 0.0},
        [2] = {x = -254.88, y = 6324.5, z = 32.58, h = 0.0},
        [3] = {x = 1830.46, y = 3676.80, z = 34.27, h = 0.0}
    },    
    ["vehicle"] = {
        [1] = {x = 294.62, y = -610.42, z = 43.25, h = 68.456},
        [2] = {x = -234.28, y = 6329.16, z = 32.15, h = 222.5},
        [3] = {x = 1836.50, y = 3699.02, z = 34.22, h = 302.0},
        [4] = {x = 326.60, y = -587.59, z = 28.79, h = 336.362},
        [5] = {x = 5007.86, y = -5195.16, z = 2.51, h = 295.53}, -- Cayo Perico
    },
    ["helicopter"] = {
    ...
    ["roof"] = {
        ...
        [2] = {x = 341.20, y = -580.92, z = 28.79, h = 245.5},
        [3] = {x = 338.5, y = -583.85, z = 74.16, h = 245.5},
    },
    ["main"] = {
        [1] = {x = 332.51, y = -595.74, z = 43.28, h = 76.0},
        [2] = {x = 330.28, y = -601.11, z = 43.28, h = 76.0},
        [3] = {x = 340.05, y = -584.70, z = 28.79, h = 76.0},
    },
    [1]  = {
        ["beds"] = { --stad
    ...
    [3] = { -- sandy
        ["beds"] = {
            [1] = {x = 1822.19, y = 3674.03, z = 35.66, h = 120.45, taken = false, model = 1631638868},
            [2] = {x = 1823.42, y = 3672.28, z = 35.66, h = 120.45, taken = false, model = 1631638868},
            [3] = {x = 1820.07, y = 3669.48, z = 35.66, h = 299.95, taken = false, model = 1631638868},
            [4] = {x = 1818.95, y = 3671.15, z = 35.66, h = 299.95, taken = false, model = 1631638868},
            [5] = {x = 1816.94, y = 3674.52, z = 35.66, h = 299.95, taken = false, model = 1631638868},
            [6] = {x = 1818.04, y = 3672.92, z = 35.66, h = 299.95, taken = false, model = 1631638868},
        },
    },
    [2] = { -- paleto
        ["beds"] = {
            [1] = {x = -260.28, y = 6319.45, z = 33.30, h = 46.33, taken = false, model = 1631638868},
            [2] = {x = -261.68, y = 6317.54, z = 32.76, h = 46.33, taken = false, model = 1631638868},
            [3] = {x = -266.04, y = 6319.76, z = 32.76, h = 225.25, taken = false, model = 1631638868},
            [4] = {x = -267.96, y = 6317.76, z = 32.76, h = 225.25, taken = false, model = 1631638868},
            [5] = {x = -258.37, y = 6314.53, z = 32.76, h = 317.66, taken = false, model = 1631638868},
            [6] = {x = -259.53, y = 6308.54, z = 32.76, h = 48.44, taken = false, model = 1631638868},
        },
    },    
} 

Config.Vehicles = {
    ["asprinter"] = "Mercedes-Benz Sprinter [CH]",
    ["aeklasse"] = "Mercedes-Benz E-Klasse [CH]",
    ["arapid"] = "Volkswagen Touran [RR]",
    ["aaudi"] = "Audi Q7 [MMT]",
    ["amicu"] = "Micu [MMT]",
    ["aml63"] = "Mercedes-Benz ML 63 [Leiding]",
    ["ammt"] = "Volvo XC90 [MMT]",
    ["aolvovdg"] = "Volvo XC40 [OVDG]",
    ["amotor"] = "Motor [RR]",
    ["aamarok"] = "Volkswagen Amarok [VK]",
    ["ambu2"] = "Ambulance Boxer [CH]",
    ["sorthyun"] = "SORT hyundai [Leiding]",
}
...
Config.BleedingStates = {
    [1] = {label = 'een klein beetje aan het bloeden..', damage = 10, chance = 50},
