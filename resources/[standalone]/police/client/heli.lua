...
local polmav_hash2 = GetHashKey("paugusta")
			...
			if PlayerJob.name == 'police' then
				...
				if IsPlayerInPolmav() then
					...
					if IsHeliHighEnough(heli) then
						if not IsVehicleModel(heli, polmav_hash2) then
...
function IsPlayerInPolmav()
	...
	return IsVehicleModel(vehicle, polmav_hash) or IsVehicleModel(vehicle, polmav_hash2) 
end  
