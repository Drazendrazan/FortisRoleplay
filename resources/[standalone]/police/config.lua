...
Config.Locations = {
   ["duty"] = {
       [1] = {x = 442.27, y = -982.42, z = 30.55, h = 30.68},
       [2] = {x = -449.811, y = 6012.909, z = 31.815, h = 90.654},
       [3] = {x = 1853.75, y = 3690.68, z = 34.09}, -- Sandy
   },    
   ["vehicle"] = {
       [1] = {x = 468.12, y = -1001.78, z = 26.82, h = 263.727},
       [2] = {x = 450.94, y = -1010.80, z = 28.50, h = 184.7},
       [3] = {x = -455.39, y = 6002.02, z = 31.34, h = 87.93},
       [4] = {x = 1868.73, y = 3694.97, z = 33.59, h = 224.16}, -- Sandy
       [5] = {x = 5007.86, y = -5195.16, z = 2.51, h = 295.53}, -- Cayo Perico
   },
   ["stash"] = {
       [1] = {x = 442.02, y = -983.87, z = 34.29, h = 90.654},
       [2] = {x = -434.63, y = 6001.63, z = 31.71, h = 316.5, r = 1.0},
       [3] = {x = 1845.76, y = 3692.49, z = 34.26}, -- Sandy
   },     
   ["impound"] = {
       [1] = {x = 469.05, y = -989.52, z = 26.82, h = 263.727},
   ...
   ["armory"] = {
       [1] = {x = 442.06, y = -988.05, z = 34.29, h = 90.654},
       [2] = {x = -436.82, y = 5996.98, z = 31.716, h = 90.654},
       [3] = {x = 1841.67, y = 3690.68, z = 34.26}, -- Sandy
   },   
   ["trash"] = {
       [1] = {x = 459.61, y = -989.33, z = 27.48},
   },      
   ["fingerprint"] = {
       [1] = {x = 452.42, y = -1000.17, z = 27.48, h = 358.5},
       [2] = {x = -442.38, y = 6011.9, z = 27.98, h = 311.5},
       [3] = {x = 1848.50, y = 3680.78, z = 30.25} -- Sandy
   },
   ["evidence"] = {
        [1] = {x = 457.56, y = -986.23, z = 27.48},
        [2] = {x = -439.09, y = 6003.12, z = 31.84, h = 90.654},
    },    
    ["evidence2"] = {
        [1] = {x = 459.44, y = -986.23, z = 27.48, h = 358.5},
        [2] = {x = -439.54, y = 6011.42, z = 27.98, h = 44.5, r = 1.0},
    },   
    ["evidence3"] = {
        --[1] = {x = 475.87, y = -996.29, z = 26.3, h = 272.5},
...
Config.ArmoryWhitelist = {
    "AOD46614", -- Toto
    "VEE70702", -- Frenky
    "BDD80276", -- Jason Green
    "TSU89949", -- Henk de Steen
    "IHB40603", -- Mika Lachman
}
...
Config.Vehicles = {
    [1] = {naam = "Volkswagen Touran", spawn = "ptouran"},
    [2] = {naam = "Mercedes B-Klasse", spawn = "pbklasse"},
    [3] = {naam = "Audi A6", spawn = "paudi"},
    [4] = {naam = "Volkswagen Amarok (Off-road)", spawn = "pamarok"},
    [5] = {naam = "Yamaha Motor (Off-road)", spawn = "pyamahamotor"},
    [6] = {naam = "BMW Motor", spawn = "r1250rt"},
    [7] = {naam = "Unmarked Schafter", spawn = "pschafter"},
    [8] = {naam = "Unmarked Oracle", spawn = "poracle"},
    [9] = {naam = "Volvo V90 Unmarked VP", spawn = "pv90"},
    [10] = {naam = "Mercedes Vito (Recherche/DSI)", spawn = "dsivito"},
    [11] = {naam = "Audi A4 Avant VP", spawn = "paa4"},
    [12] = {naam = "Audi rs6 unmarked", spawn = "rs6avant20"},
    [13] = {naam = "Bearcat (DSI)", spawn = "pbearcat"},
    ...
    items = {
        ...
        [6] = {
            ...
            info = {
                ...
                attachments = {
                    {component = "COMPONENT_AT_AR_FLSH", label = "Flashlight"},
                    {component = "COMPONENT_AT_AR_SUPP", label = "Demper"},
