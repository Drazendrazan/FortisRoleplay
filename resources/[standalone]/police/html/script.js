...
SnelheidsRadar.Open = function(data) {
    $(".snelheids-wrapper").css("display", "block");
    $("#snelheids-kenteken").html("Kenteken: " + data.plate);
    $("#snelheids-km").html(data.speed + " KM/U");
}

SnelheidsRadar.Sluit = function(data) {
    $(".snelheids-wrapper").css("display", "none");
}
...
document.onreadystatechange = () => {
    if (document.readyState === "complete") {
        window.addEventListener('message', function(event) {
            ...
            } else if (event.data.type == "snelheidinfo") {
                SnelheidsRadar.Open(event.data);
            } else if (event.data.type == "snelheidUit") {
                SnelheidsRadar.Sluit(event.data);
            }
        });
    };
};
