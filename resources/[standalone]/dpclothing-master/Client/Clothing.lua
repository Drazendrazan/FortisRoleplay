...
RegisterNetEvent("kleding:handschoenen")
AddEventHandler("kleding:handschoenen", function()
	ExecuteCommand("handschoenen")
end)

RegisterNetEvent("kleding:schoenen")
AddEventHandler("kleding:schoenen", function()
	ExecuteCommand("schoenen")
end)

RegisterNetEvent("kleding:masker")
AddEventHandler("kleding:masker", function()
	ExecuteCommand("masker")
end)

RegisterNetEvent("kleding:jas")
AddEventHandler("kleding:jas", function()
	ExecuteCommand("shirt")
end)

RegisterNetEvent("kleding:broek")
AddEventHandler("kleding:broek", function()
	ExecuteCommand("broek")
end)

RegisterNetEvent("kleding:hoed")
AddEventHandler("kleding:hoed", function()
	ExecuteCommand("hoed")
end)

RegisterNetEvent("kleding:bril")
AddEventHandler("kleding:bril", function()
	ExecuteCommand("bril")
end)
