...
$(document).ready(function(){
    ...
    $('.vehicle-category').click(function(e){
        ...
        if (vehicleCategory == "home") {
            ...
            if ($('.vehicle-shop-home').css("display") !== "none") {
                $.post('http://fortis-vehicleshop/GetCategoryVehicles', JSON.stringify({
    ...
    $('.map-pin').click(function(e){
        ...
        $.post('http://fortis-vehicleshop/buyVehicle', JSON.stringify({
...
$(document).on('keydown', function() {
    switch(event.keyCode) {
        case 27: // ESC
            $.post('http://fortis-vehicleshop/exit')
            break;
    }
});