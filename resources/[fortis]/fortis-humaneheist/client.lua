...
Citizen.CreateThread(function()
    ...
    while true do
        ...
        if koopDist < 2 then
            ...
            if not verhaal2 then
                ...
                if IsControlJustPressed(0, 48) then
                    TriggerServerEvent("fortis-humaneheist:server:koopArtikelen", "bag", 1500)
                    verhaal2 = true
                    verhaal1 = false
                end
                if IsControlJustPressed(0, 47) then
                    TriggerServerEvent("fortis-humaneheist:server:koopArtikelen", "cutter", 5000)
                    verhaal2 = true
                    verhaal1 = false
                end 
                if IsControlJustPressed(0, 73) then
                    TriggerServerEvent("fortis-humaneheist:server:koopArtikelen", "laptop", 2000)
                    verhaal2 = true
                    verhaal1 = false
                end
        ...
        if alarmDist < 5 then
            if not alarm then
                TriggerServerEvent("fortis-humaneheist:server:triggerscoreboard")
                belPolitie()
                alarm = true
            end
        end
...
function belPolitie()
    ...
    TriggerServerEvent('fortis-humaneheist:server:belPolitie', streetLabel, pos)
end

RegisterNetEvent('fortis-humaneheist:client:belPolitieBericht')
AddEventHandler('fortis-humaneheist:client:belPolitieBericht', function(msg, streetLabel, coords)
