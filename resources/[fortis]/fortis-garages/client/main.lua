        ...
        if result == nil then
            ...
            for _ , v in pairs(result) do
                ...
                impoundMenu[#impoundMenu+1] = {
                    ...
                    params = {
                        event = "fortis-garages:client:TakeOutvehicle",
                        args = {
                            vehicle = v,
                        }
                    }
...
RegisterNetEvent("fortis-garages:client:TakeOutvehicle", function(vehicledata)
...
function MenuDepot()
    ...
    QBCore.Functions.TriggerCallback("qb-garage:server:GetDepotVehicles", function(result)
        ...
        if result == nil then
            ...
            for _ , v in pairs(result) do
                ...
                depotMenu[#depotMenu+1] = {
                    ...
                    params = {
                        event = "fortis-garages:client:TakeOutDepotVehicle",
                        args = {
                            vehicle = v,
                        }
                    }
        ...
        if shouldContinue then
            ...
            exports['fortis-menu']:openMenu(depotMenu)
        end
    end)
end
...
function MenuHouseGarage(house)
    ...
    QBCore.Functions.TriggerCallback("qb-garage:server:GetHouseVehicles", function(result)
        ...
        if result == nil then
            ...
            for _ , v in pairs(result) do
                ...
                huisMenu[#huisMenu+1] = {
                    ...
                    txt = "Motor: " .. enginePercent .. "% | Brandstof: "..currentFuel.. "% | Status: "..status.." | Kenteken: "..plate,
                    params = {
                        event = "fortis-garages:client:TakeOutGarageVehicle",
                        args = {
                            vehicle = v,
                        }
                    }
        ...
        if shouldContinue then
            ...
            exports['fortis-menu']:openMenu(huisMenu)
        end
    end, house)
end

RegisterNetEvent("fortis-garages:client:TakeOutGarageVehicle", function(vehicledata)
...
RegisterNetEvent("fortis-garages:client:TakeOutDepotVehicle", function(vehicledata)
    local vehicle = vehicledata.vehicle
            ...
            if putDist <= 25 and IsPedInAnyVehicle(ped) then
                ...
                if putDist <= 1.5 then
                    ...
                    if IsControlJustPressed(0, 38) then
                        ...
                        TriggerServerEvent("fortis-voertuigsleutels:server:verwijderSleutel", plate)
                    ...
                    if IsPedInAnyVehicle(ped) then
                        ...
                        QBCore.Functions.TriggerCallback("qb-garage:server:checkVehicleOwner", function(resultaat)
                            if resultaat ~= nil and resultaat[1].citizenid == playerCitizenId then
                                DoScreenFadeOut(500)
                                Wait(1000)
                                TriggerEvent("fortis-garages:client:wachten", plate)
                                QBCore.Functions.DeleteVehicle(curVeh)
                                Wait(1000)
                                DoScreenFadeIn(1000)
...
AddEventHandler("fortis-garages:client:wachten", function(plate)
    ...
    TriggerServerEvent("fortis-garages:server:verscheep", plate)
end)