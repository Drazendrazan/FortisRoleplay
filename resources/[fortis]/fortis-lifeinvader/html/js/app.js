...
const app = {
    ...
    methods: {
        ...
        stage(aantal) {
            ...
            if (this.stage7) {
                setTimeout(() => {
                    ...
                    this.timer = false; 
                    clearInterval(Timer);
                    $.post("https://fortis-lifeinvader/Succesvol", JSON.stringify({}));
                }, 1000);
            }
        },
        ...
        VerlaatKast() {
            ...
            $.post("https://fortis-lifeinvader/verlaat", JSON.stringify({})); 
        }, 
        ...
        KastFailed() {
            ...
            $.post("http://fortis-lifeinvader/failed", JSON.stringify({}));
        }
    }
}
