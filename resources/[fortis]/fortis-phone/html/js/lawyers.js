SetupLawyers = function(data) {
    ...
    if (data.length > 0) {
        ...
        $(".lawyers-list").append('<h1 style="font-size:1.641025641025641vh; padding:1.0256410256410255vh; color:#fff; margin-top:0; border-top-left-radius: .5vh; border-top-right-radius: .5vh; width:100%; display:block; background-color: rgb(42, 137, 214);">Advocaten (' + lawyers.length + ')</h1>');
        ...
        $(".lawyers-list").append('<br><h1 style="font-size:1.641025641025641vh; padding:1.0256410256410255vh; color:#fff; margin-top:0; width:100%; display:block; background-color: rgb(155, 15, 120);">Makelaars (' + realestate.length + ')</h1>');
        ...
        if (realestate.length > 0) {
            ...
            var element = '<div class="lawyer-list"><div class="no-lawyers">Er zijn geen makelaars beschikbaar.</div></div>'
            $(".lawyers-list").append(element);
        }
        ...
        if (taxi.length > 0) {
            ...
            var element = '<div class="lawyer-list"><div class="no-lawyers">Er zijn geen taxis beschikbaar.</div></div>'
            $(".lawyers-list").append(element);
        }
...
$(document).on('click', '.lawyer-list-call', function(e){
    ...
    $.post('https://fortis-phone/CallContact', JSON.stringify({
        ContactData: cData,
        ...
        if (cData.number !== QB.Phone.Data.PlayerData.charinfo.phone) {
            if (status.IsOnline) {
                if (status.CanCall) {
                    if (!status.InCall) {
                        ...
                        QB.Phone.Notifications.Add("fas fa-phone", "Phone", "Je bent in gesprek!");
                    }
                } else {
            ...
            QB.Phone.Notifications.Add("fas fa-phone", "Phone", "Je kan niet jezelf bellen!");
        }
    });
});
