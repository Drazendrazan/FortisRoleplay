...
$(document).on('click', '.house-key-delete', function(e){
    ...
    $.post('https://fortis-phone/RemoveKeyholder', JSON.stringify({
        HolderData: Data,
...
$(document).on('click', '#myhouse-option-transfer-confirm', function(e){
    ...
    $.post('https://fortis-phone/TransferCid', JSON.stringify({
        newBsn: NewBSN,
        HouseData: CurrentHouseData,
        ...
        if (CanTransfer) { 
            ...
            setTimeout(function(){
                $.post('https://fortis-phone/GetPlayerHouses', JSON.stringify({}), function(Houses){
                    SetupPlayerHouses(Houses);
                    $(".myhouses-options-container").fadeOut(150);
                });
            }, 100);
        } else { 
            QB.Phone.Notifications.Add("fas fa-home", "Houses", "Dit BSN bestaat niet!", "#27ae60", 2500);
