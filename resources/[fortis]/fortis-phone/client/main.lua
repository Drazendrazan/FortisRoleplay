...
RegisterNUICallback('GetCryptoData', function(data, cb)
    QBCore.Functions.TriggerCallback('fortis-bitcoin:server:GetCryptoData', function(CryptoData)
        cb(CryptoData)
    end, data.crypto)
end)

RegisterNUICallback('BuyCrypto', function(data, cb)
    QBCore.Functions.TriggerCallback('fortis-bitcoin:server:BuyCrypto', function(CryptoData)
        cb(CryptoData)
    end, data)
end)

RegisterNUICallback('SellCrypto', function(data, cb)
    QBCore.Functions.TriggerCallback('fortis-bitcoin:server:SellCrypto', function(CryptoData)
        cb(CryptoData)
    end, data)
end)

RegisterNUICallback('TransferCrypto', function(data, cb)
    QBCore.Functions.TriggerCallback('fortis-bitcoin:server:TransferCrypto', function(CryptoData)
        cb(CryptoData)
    end, data)
end)
...
RegisterNUICallback('GetAvailableRaces', function(data, cb)
    QBCore.Functions.TriggerCallback('fortis-lapraces:server:GetRaces', function(Races)
        cb(Races)
    end )
end)

RegisterNUICallback('JoinRace', function(data)
    TriggerServerEvent('fortis-lapraces:server:JoinRace', data.RaceData)
end)

RegisterNUICallback('LeaveRace', function(data)
    TriggerServerEvent('fortis-lapraces:server:LeaveRace', data.RaceData)
end)

RegisterNUICallback('StartRace', function(data)
    TriggerServerEvent('fortis-lapraces:server:StartRace', data.RaceData.RaceId)
end)
...
RegisterNUICallback('GetRaces', function(data, cb)
    QBCore.Functions.TriggerCallback('fortis-lapraces:server:GetListedRaces', function(Races)
        cb(Races)
    end)
end)

RegisterNUICallback('GetTrackData', function(data, cb)
    QBCore.Functions.TriggerCallback('fortis-lapraces:server:GetTrackData', function(TrackData, CreatorData)
...
RegisterNUICallback('SetupRace', function(data, cb)
    TriggerServerEvent('fortis-lapraces:server:SetupRace', data.RaceId, tonumber(data.AmountOfLaps))
end)

RegisterNUICallback('HasCreatedRace', function(data, cb)
    QBCore.Functions.TriggerCallback('fortis-lapraces:server:HasCreatedRace', function(HasCreated)
        cb(HasCreated)
    end)
end)

RegisterNUICallback('IsInRace', function(data, cb)
    local InRace = exports['fortis-lapraces']:IsInRace()
    cb(InRace)
end) 

RegisterNUICallback('IsAuthorizedToCreateRaces', function(data, cb)
    QBCore.Functions.TriggerCallback('fortis-lapraces:server:IsAuthorizedToCreateRaces', function(IsAuthorized, NameAvailable)
        local data = {
            IsAuthorized = IsAuthorized,
            IsBusy = exports['fortis-lapraces']:IsInEditor(),
...
RegisterNUICallback('StartTrackEditor', function(data, cb)
    TriggerServerEvent('fortis-lapraces:server:CreateLapRace', data.TrackName)
end)

RegisterNUICallback('GetRacingLeaderboards', function(data, cb)
    QBCore.Functions.TriggerCallback('fortis-lapraces:server:GetRacingLeaderboards', function(Races)
        cb(Races)
    end)
end)

RegisterNUICallback('RaceDistanceCheck', function(data, cb)
    QBCore.Functions.TriggerCallback('fortis-lapraces:server:GetRacingData', function(RaceData)
        local ped = GetPlayerPed(-1)
        ...
        if dist <= 115.0 then
            if data.Joined then
                TriggerEvent('fortis-lapraces:client:WaitingDistanceCheck')
            end
            cb(true)
        else
...
RegisterNUICallback('IsBusyCheck', function(data, cb)
    if data.check == "editor" then
        cb(exports['fortis-lapraces']:IsInEditor())
    else
        cb(exports['fortis-lapraces']:IsInRace())
    end
end)

RegisterNUICallback('CanRaceSetup', function(data, cb)
    QBCore.Functions.TriggerCallback('fortis-lapraces:server:CanRaceSetup', function(CanSetup)
        cb(CanSetup)
    end)
end)
...
RegisterNUICallback('GetPlayerHouses', function(data, cb)
    QBCore.Functions.TriggerCallback('fortis-houses:server:GetPlayerHouses', function(Houses)
        cb(Houses)
    end) 
end)

RegisterNUICallback('GetPlayerKeys', function(data, cb)
    QBCore.Functions.TriggerCallback('fortis-houses:server:GetHouseKeys', function(Keys)
        cb(Keys)
    end)
end)
...
RegisterNUICallback('GetWeerData', function(data, cb)
    QBCore.Functions.TriggerCallback("fortis-weathersync:server:weerAppData", function(data)
...
RegisterNUICallback('hulpdienstenMeldingANWB', function(data, cb)
    TriggerEvent("fortis-vehicletuning:client:SendEmergencyMessage", data.bericht)
end)
    ...
    while true do
        ...
        if twitterCamActive then
            ...
            if IsControlJustPressed(0, 176) and not twitterFotoGemaakt then -- Foto maken
                ...
                QBCore.Functions.TriggerCallback("fortis-screenshots:server:twitterMaakFoto", function(gelukt, url)
                    if gelukt then
