...
QBCore.Functions.CreateUseableItem("contract", function(source, item)
    TriggerClientEvent("fortis-voertuigcontract:client:useItem", source)
end)

verkopers = {}

QBCore.Functions.CreateCallback("fortis-voertuigcontract:server:checkVoertuigOwner", function(source, cb, kenteken, boot)
    local src = source
...
RegisterServerEvent("fortis-voertuigcontract:server:geefContract")
AddEventHandler("fortis-voertuigcontract:server:geefContract", function(target, bedrag, kenteken)
    local src = source
    local Player = QBCore.Functions.GetPlayer(src)
    ...
    TriggerClientEvent("fortis-voertuigcontract:client:krijgContract", target, bedrag, kenteken)
    print(dump(verkopers))
end)

RegisterServerEvent("fortis-voertuigcontract:server:koopVoertuig")
AddEventHandler("fortis-voertuigcontract:server:koopVoertuig", function(bedrag, kenteken, boot)
    local src = source
...
QBCore.Functions.CreateCallback("fortis-voertuigcontract:server:checkVliegtuigOwner", function(source, cb, kenteken, boot)
    local src = source
    local Player = QBCore.Functions.GetPlayer(src)
    local citizenid = Player.PlayerData.citizenid
    local kenteken = kenteken
...
RegisterServerEvent("fortis-voertuigcontract:server:koopVliegmachine")
AddEventHandler("fortis-voertuigcontract:server:koopVliegmachine", function(bedrag, kenteken, heli)
    local src = source
    local bedrag = tonumber(bedrag)
...
RegisterServerEvent("fortis-voertuigcontract:server:koopcontract")
AddEventHandler("fortis-voertuigcontract:server:koopcontract", function()
    local src = source
    local Player = QBCore.Functions.GetPlayer(src)
