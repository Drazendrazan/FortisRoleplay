    ...
    this.listener = window.addEventListener("message", (event) => {
      switch (event.data.action) {
        ...
        case "show":
          ...
          break;
        case "HudZichtbaarheid":
          if (event.data.HudZichtbaarheid === "none") {
            document.getElementById("heleBody").style.display = "none";
          }else {
            document.getElementById("heleBody").style.display = "block";
          }
          break;
      }
    }); 
...
// const zichtbaarheid = {
//   methods: {
//     toggleZichtbaarheid(data) {
//       if (data.HudZichtbaarheid === "none") {
