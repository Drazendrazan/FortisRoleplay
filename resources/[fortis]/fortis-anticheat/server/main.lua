...
AddEventHandler('qb-anticheat:server:banPlayer', function(reason)
    ...
    DropPlayer(src, "You have been flagged to much, for more information join our discord: https://fortisroleplay.nl/discord :)")
end)
...
AddEventHandler("giveWeaponEvent", function(source, data)
	...
	TriggerClientEvent("qb-anticheat:client:NonRegisteredEventCalled", src, "Cheating", "Heeft geprobeerd wapens te geven")
end)

AddEventHandler('explosionEvent', function(source, data)
	local src = tonumber(source)
	
	if Config.ExplosionsList[data.explosionType] then
		TriggerClientEvent("qb-anticheat:client:NonRegisteredEventCalled", src, "Cheating", "Heeft geprobeerd explosies in te spawnen")
	end
end)
...
AddEventHandler("clearPedTasksEvent", function(source, data)
	...
	if data.immediately then
		TriggerClientEvent("qb-anticheat:client:NonRegisteredEventCalled", src, "Cheating", "Heeft geprobeerd 'clearPedTasksImmediately' te doen bij een andere persoon")
	end
end)