...
Citizen.CreateThread(function()
    QBCore.Functions.TriggerCallback("fortis-bmshop:server:checkDealer", function(locatie)
...
RegisterNUICallback("kopen", function(data, cb)
    ...
    TriggerServerEvent("fortis-bmshop:server:koopAttachment", id)
end)
...
RegisterNetEvent("fortis-bmshop:client:emote")
AddEventHandler("fortis-bmshop:client:emote", function()
    local ped = GetPlayerPed(-1)
