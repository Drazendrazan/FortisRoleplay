...
AddEventHandler('qb-diving:client:UseJerrycan', function()
    ...
    if IsPedInAnyVehicle(GetPlayerPed(-1), false) then
        ...
        if GetDistanceBetweenCoords(pos.x, pos.y, pos.z, vehpos.x, vehpos.y, vehpos.z, true) < 2.4 then
            ...
            QBCore.Functions.Progressbar("reful_boat", "Tank bijvullen...", 20000, false, true, {
                disableMovement = true,
                disableMouse = false,
                disableCombat = true,
            }, {}, {}, {}, function() -- Done
                exports['LegacyFuel']:SetFuel(curVeh, 100)
                QBCore.Functions.Notify('De tank is bijgevuld!', 'success')
            ...
            QBCore.Functions.Notify('Je staat niet in de buurt van een voertuig.', 'error')
        end
    end
end)
