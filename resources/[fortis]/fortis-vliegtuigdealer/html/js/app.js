window.addEventListener("message", function(event) {
    if (event.data.type == "open") {
        ...
        $.post("http://fortis-vliegtuigdealer/sluiten", JSON.stringify({}));
...
const app = {
    ...
    methods: {
        ...
        openHome() {
            this.navAutos = true;
            $.post("http://fortis-vliegtuigdealer/verwijderVoertuig", JSON.stringify({}));
            $("#cardealerinfo").slideUp(500);
            this.resetScroller();
        },
        ...
        previewVoertuig(voertuig, keyIndex) {
            ...
            $.post("http://fortis-vliegtuigdealer/previewVoertuig", JSON.stringify({
                voertuig: voertuig
            }));
        ...
        kopen() {
            ...
            $.post("http://fortis-vliegtuigdealer/kopen", JSON.stringify({
