...
AddEventHandler('qb-jewellery:server:vitrineReward', function()
    ...
    if otherchance == odd then
        ...
        if Player.Functions.AddItem(Config.VitrineRewards[item]["item"], amount) then
            ...
            TriggerClientEvent('QBCore:Notify', src, 'De vitrine was leeg!', 'error')
        end
    else
        ...
        if Player.Functions.AddItem("10kgoldchain", amount) then
            ...
            TriggerClientEvent('QBCore:Notify', src, 'Je hebt geen plek meer!', 'error')
        end
    end
end)
...
AddEventHandler('qb-jewellery:server:PoliceAlertMessage', function(title, coords, blip)
    ...
    local alertData = {
        ...
        description = "Er is een verdachte situatie bij de Vangelico Juwelier, <br>Beschikbare camera's: 31, 32, 33, 34",
    }
