...
QBCore.Functions.CreateUseableItem("fortel", function(source, item)
    ...
    if Player.PlayerData.job.name == "police" or Player.PlayerData.job.name == "ambulance" then
        ...
        TriggerClientEvent("fortis-customdrugs:client:openTelefoon", source, item["info"].simkaart)
    end
end)

-- Check of persoon fortel heeft als hij bij de ATM machine wilt inloggen
QBCore.Functions.CreateCallback("fortis-customdrugs:server:checkTelefoonBitcoinATM", function(source, cb)
    local Player = QBCore.Functions.GetPlayer(source)
...
-- Check of persoon fortel heeft als hij een encrochat binnen krijgt
QBCore.Functions.CreateCallback("fortis-customdrugs:server:checkEncroFortel", function(source, cb)
    local Player = QBCore.Functions.GetPlayer(source)
...
RegisterNetEvent("fortis-customdrugs:server:belPolitie")
AddEventHandler("fortis-customdrugs:server:belPolitie", function(straat, coords)
...
-- Encrochat
RegisterNetEvent("fortis-customdrugs:server:nieuwEncroChat")
AddEventHandler("fortis-customdrugs:server:nieuwEncroChat", function(chat, bericht)
    local src = source

    TriggerClientEvent("fortis-customdrugs:client:addEncroChat", -1, chat, bericht, src)
    if chat == 1 then
...
-- Crypto
QBCore.Functions.CreateCallback("fortis-customdrugs:server:requestCrypto", function(source, cb)
    local src = source
...
QBCore.Functions.CreateCallback("fortis-customdrugs:server:koopCrypto", function(source, cb, aantal)
    local src = source
    local Player = QBCore.Functions.GetPlayer(src)
...
QBCore.Functions.CreateCallback("fortis-customdrugs:server:pinBitcoin", function(source, cb, aantal)
    local src = source
    local Player = QBCore.Functions.GetPlayer(src)
...
-- Anonieme twitter
QBCore.Functions.CreateCallback("fortis-customdrugs:server:anonTweetAfschrijven", function(source, cb)
    local Player = QBCore.Functions.GetPlayer(source)
...
QBCore.Functions.CreateCallback("fortis-customdrugs:server:haalLabOp", function(source, cb)
    local src = source
    local Player = QBCore.Functions.GetPlayer(src)
    local citizenid = Player.PlayerData.citizenid
            ...
            if decoded["informatie"].type == "basic" then
                ...
                if not heeftGecheckt then
                    if math.random(1, 150) == 69 then
                        ...
                        TriggerClientEvent("fortis-customdrugs:client:labOpgerold", src)
                        cb(false, {})
                    else
                        cb(true, resultaat[1].labinfo)
...
QBCore.Functions.CreateCallback("fortis-customdrugs:server:koopLab", function(source, cb, labType)
    local Player = QBCore.Functions.GetPlayer(source)
...
RegisterNetEvent("fortis-customdrugs:server:verkoopLab")
AddEventHandler("fortis-customdrugs:server:verkoopLab", function(type)
    local src = source
    local Player = QBCore.Functions.GetPlayer(src)
    local citizenid = Player.PlayerData.citizenid
...
QBCore.Functions.CreateCallback("fortis-customdrugs:server:vraagLabShell", function(source, cb, lab)
...
RegisterNetEvent("fortis-customdrugs:server:maakShellVrij")
AddEventHandler("fortis-customdrugs:server:maakShellVrij", function(shellnummer)
...
QBCore.Functions.CreateCallback("fortis-customdrugs:server:checkVermeng", function(source, cb)
    local src = source
    local Player = QBCore.Functions.GetPlayer(src)
...
QBCore.Functions.CreateCallback("fortis-customdrugs:server:checkVersnijden", function(source, cb)
    local src = source
    local Player = QBCore.Functions.GetPlayer(src)
...
QBCore.Functions.CreateCallback("fortis-customdrugs:server:checkVerpakken", function(source, cb)
    local src = source
    local Player = QBCore.Functions.GetPlayer(src)
...
RegisterNetEvent("fortis-customdrugs:server:labProcesGeef")
AddEventHandler("fortis-customdrugs:server:labProcesGeef", function(type)
    local src = source
    local Player = QBCore.Functions.GetPlayer(src)
...
RegisterNetEvent("fortis-customdrugs:server:geefGrondstoffen")
AddEventHandler("fortis-customdrugs:server:geefGrondstoffen", function()
    local src = source
    local Player = QBCore.Functions.GetPlayer(src)
...
QBCore.Functions.CreateCallback("fortis-customdrugs:server:checkAantalVerpakteCocaine", function(source, cb, aantal)
    local src = source
    local Player = QBCore.Functions.GetPlayer(src)
...
-- Locaties kopen
QBCore.Functions.CreateCallback("fortis-customdrugs:server:koopLocatie", function(source, cb)
    local Player = QBCore.Functions.GetPlayer(source)

    if Player.PlayerData.money["crypto"] >= 15 then
        Player.Functions.RemoveMoney("crypto", 15, "Locatie gekocht via de Fortel")
        cb(true)
    else
        cb(false)
    end
...
-- Blackmarket chat
RegisterNetEvent("fortis-customdrugs:server:BmBericht")
AddEventHandler("fortis-customdrugs:server:BmBericht", function(bericht)
    local src = source
    local Player = QBCore.Functions.GetPlayer(src)
...
QBCore.Functions.CreateCallback("fortis-customdrugs:server:requestBmChat", function(source, cb)
    local Player = QBCore.Functions.GetPlayer(source)
    local citizenid = Player.PlayerData.citizenid 
...
QBCore.Functions.CreateUseableItem("simkaart", function(source, item)
    ...
    if Player.Functions.GetItemByName("fortel") ~= nil then
	    if Player.Functions.RemoveItem(item.name, 1, item.slot) then
            Player.Functions.RemoveItem("fortel", 1)
            Wait(100)
            Player.Functions.AddItem("fortel", 1, nil, kaas)
            TriggerClientEvent("QBCore:Notify", source, "Je hebt de simkaart in je Fortel gestopt!", "success")
        end
    else
        TriggerClientEvent("QBCore:Notify", source, "Je hebt geen Fortel bij je!", "error")
    end
end)
...
-- /stoptaak
QBCore.Commands.Add("stoptaak", "Stop je Fortel taak.", {}, false, function(source, args)
	local Player = QBCore.Functions.GetPlayer(source)
    TriggerClientEvent("fortis-customdrugs:client:stopTaak", source)
...
RegisterNetEvent("fortis-customdrugs:server:missie:autoStelenGeefItems")
AddEventHandler("fortis-customdrugs:server:missie:autoStelenGeefItems", function()
    local Player = QBCore.Functions.GetPlayer(source)
...
QBCore.Functions.CreateCallback("fortis-customdrugs:server:checkKeyFobConnector", function(source, cb, stap)
    local Player = QBCore.Functions.GetPlayer(source)
...
RegisterNetEvent("fortis-customdrugs:server:missie:autoStelenInleveren")
AddEventHandler("fortis-customdrugs:server:missie:autoStelenInleveren", function()
    local src = source
    local Player = QBCore.Functions.GetPlayer(src)
    ...
    if math.random(1, 90) == 69 then -- Sim kaart reward
        ...
        if aantal > 2 then
            ...
            Player.Functions.AddMoney("crypto", aantal, "Fortel Auto missie")
        else
...
RegisterNetEvent("fortis-customdrugs:server:missie:containerOpenbrekenGeefItems")
AddEventHandler("fortis-customdrugs:server:missie:containerOpenbrekenGeefItems", function()
    local src = source
    local Player = QBCore.Functions.GetPlayer(src)
...
QBCore.Functions.CreateCallback("fortis-customdrugs:server:missie:checkLasapparaat", function(source, cb)
    local Player = QBCore.Functions.GetPlayer(source)
...
QBCore.Functions.CreateCallback("fortis-customdrugs:server:missie:checkDrugskoffer", function(source, cb)
    local Player = QBCore.Functions.GetPlayer(source)
...
RegisterNetEvent("fortis-customdrugs:server:missie:containerOpenbrekenSucces")
AddEventHandler("fortis-customdrugs:server:missie:containerOpenbrekenSucces", function()
    local src = source
    local Player = QBCore.Functions.GetPlayer(src)
...
RegisterServerEvent("fortis-customdrugs:server:missie:containerOpenbrekenAfleveren")
AddEventHandler("fortis-customdrugs:server:missie:containerOpenbrekenAfleveren", function()
    local src = source
    local Player = QBCore.Functions.GetPlayer(src)
    ...
    if Player.Functions.GetItemByName("drugskoffer") ~= nil then
        ...
        if math.random(1, 90) == 69 then -- Sim kaart reward
            ...
            if aantal > 2 then
                TriggerClientEvent("QBCore:Notify", src, "Goed werk geleverd, ik heb je "..aantal.." bitcoins gegeven!", "success")
                Player.Functions.AddMoney("crypto", aantal, "Fortel container/bounty")
            else
                local viesgeld = math.random(1500, 2500)
                TriggerClientEvent("QBCore:Notify", src, "Goed werk geleverd, ik heb je €"..viesgeld.." aan viesgeld gegeven!", "success")
                Player.Functions.AddItem("viesgeld", viesgeld)
...
RegisterNetEvent("fortis-customdrugs:server:missie:krijgUSB")
AddEventHandler("fortis-customdrugs:server:missie:krijgUSB", function()
    local src = source
    local Player = QBCore.Functions.GetPlayer(src)
...
QBCore.Functions.CreateCallback("fortis-customdrugs:server:missie:checkUsb", function(source, cb)
    local Player = QBCore.Functions.GetPlayer(source)
...
RegisterServerEvent("fortis-customdrugs:server:missie:computerHackAfleveren")
AddEventHandler("fortis-customdrugs:server:missie:computerHackAfleveren", function()
    local src = source
    local Player = QBCore.Functions.GetPlayer(src)
    ...
    if Player.Functions.GetItemByName("usbstick") ~= nil then
        ...
        if math.random(1, 90) == 69 then -- Sim kaart reward
            ...
            if aantal > 2 then
                TriggerClientEvent("QBCore:Notify", src, "Goed werk geleverd, ik heb je "..aantal.." bitcoins gegeven!", "success")
                Player.Functions.AddMoney("crypto", aantal, "Fortel computer hack missie")
            else
                local viesgeld = math.random(1500, 2500)
                TriggerClientEvent("QBCore:Notify", src, "Goed werk geleverd, ik heb je €"..viesgeld.." aan viesgeld gegeven!", "success")
                Player.Functions.AddItem("viesgeld", viesgeld)
...
-- Pinautomaat hacken
RegisterServerEvent("fortis-customdrugs:server:missie:krijgZwartgeld")
AddEventHandler("fortis-customdrugs:server:missie:krijgZwartgeld", function()
    local src = source
    local Player = QBCore.Functions.GetPlayer(src)
...
RegisterNetEvent("fortis-customdrugs:server:missie:krijgSchilderij")
AddEventHandler("fortis-customdrugs:server:missie:krijgSchilderij", function()
    local src = source
    local Player = QBCore.Functions.GetPlayer(src)
...
QBCore.Functions.CreateCallback("fortis-customdrugs:server:missie:checkSchilderij", function(source, cb)
    local Player = QBCore.Functions.GetPlayer(source)
...
RegisterServerEvent("fortis-customdrugs:server:missie:schilderijAfleveren")
AddEventHandler("fortis-customdrugs:server:missie:schilderijAfleveren", function()
    local src = source
    local Player = QBCore.Functions.GetPlayer(src)
    ...
    if Player.Functions.GetItemByName("schilderij") ~= nil then
        ...
        if math.random(1, 90) == 69 then -- Sim kaart reward
            ...
            if aantal > 2 then
                TriggerClientEvent("QBCore:Notify", src, "Goed werk geleverd, ik heb je "..aantal.." bitcoins gegeven!", "success")
                Player.Functions.AddMoney("crypto", aantal, "Fortel schilderij steel missie")
            else
                local viesgeld = math.random(1500, 2500)
                TriggerClientEvent("QBCore:Notify", src, "Goed werk geleverd, ik heb je €"..viesgeld.." aan viesgeld gegeven!", "success")
                Player.Functions.AddItem("viesgeld", viesgeld)
...
RegisterNetEvent("fortis-customdrugs:server:missie:krijgSchroevendraaier")
AddEventHandler("fortis-customdrugs:server:missie:krijgSchroevendraaier", function()
    local Player = QBCore.Functions.GetPlayer(source)
...
RegisterNetEvent("fortis-customdrugs:client:missie:krijgKenteken")
AddEventHandler("fortis-customdrugs:client:missie:krijgKenteken", function()
    local Player = QBCore.Functions.GetPlayer(source)
...
RegisterNetEvent("fortis-customdrugs:server:missie:kentekenAfleveren")
AddEventHandler("fortis-customdrugs:server:missie:kentekenAfleveren", function()
    local src = source
    local Player = QBCore.Functions.GetPlayer(source)
    ...
    if Player.Functions.GetItemByName("kenteken") ~= nil then
        ...
        if math.random(1, 90) == 69 then -- Sim kaart reward
            ...
            if aantal > 2 then
                TriggerClientEvent("QBCore:Notify", src, "Goed werk geleverd, ik heb je "..aantal.." bitcoins gegeven!", "success")
                Player.Functions.AddMoney("crypto", aantal, "Fortel kenteken aflever missie")
            else
                local viesgeld = math.random(1500, 2500)
                TriggerClientEvent("QBCore:Notify", src, "Goed werk geleverd, ik heb je €"..viesgeld.." aan viesgeld gegeven!", "success")
                Player.Functions.AddItem("viesgeld", viesgeld)
...
QBCore.Functions.CreateCallback("fortis-customdrugs:server:missie:checkKenteken", function(source, cb)
    local Player = QBCore.Functions.GetPlayer(source)
...
--ontvoeren
QBCore.Functions.CreateCallback("fortis-customdrugs:server:missie:checkOntvoeringspullen", function(source, cb)
    local Player = QBCore.Functions.GetPlayer(source)
...
RegisterNetEvent("fortis-customdrugs:server:geefOntvoeritems")
AddEventHandler("fortis-customdrugs:server:geefOntvoeritems", function()
    local Player = QBCore.Functions.GetPlayer(source)
...
RegisterNetEvent("fortis-customdrugs:server:gebruikOntvoeritems")
AddEventHandler("fortis-customdrugs:server:gebruikOntvoeritems", function()
    local Player = QBCore.Functions.GetPlayer(source)
...
RegisterNetEvent("fortis-customdrugs:server:betalenOntvoering")
AddEventHandler("fortis-customdrugs:server:betalenOntvoering", function(betaling)
    local src = source
    local Player = QBCore.Functions.GetPlayer(source)
    if betaling < 4 then
        if math.random(1, 90) == 69 then -- Sim kaart reward
            ...
            if aantal > 2 then
                TriggerClientEvent("QBCore:Notify", src, "Goed werk geleverd, ik heb je "..aantal.." bitcoins gegeven!", "success")
                Player.Functions.AddMoney("crypto", aantal, "Fortel oentvoering missie")
            else
                local viesgeld = math.random(1500, 2500)
                TriggerClientEvent("QBCore:Notify", src, "Goed werk geleverd, ik heb je €"..viesgeld.." aan viesgeld gegeven!", "success")
                Player.Functions.AddItem("viesgeld", viesgeld)
        ...
        TriggerEvent("fortis-customdrugs:server:kauloHacker")
    end
end)


-- Anticheat!
RegisterNetEvent("fortis-customdrugs:server:kauloHacker")
AddEventHandler("fortis-customdrugs:server:kauloHacker", function()
    local src = source
    TriggerClientEvent('chatMessage', -1, "Fortis AntiCheat", "error", GetPlayerName(src).." is automatisch verbannen voor hacken binnen Fortis-Customdrugs.")
    local reason = "Fortis-Customdrugs POST triggers uitvoeren"
    ...
    DropPlayer(src, "Verbannen voor Fortis-Customdrugs POST triggers uitvoeren: https://fortisroleplay.nl/discord")
end)
