...
RegisterServerEvent("fortis-duiken:server:verkopen")
AddEventHandler("fortis-duiken:server:verkopen", function()
...
QBCore.Functions.CreateCallback("fortis-duiken:server:requestOnderwatervondst", function(source, cb)
    local Player = QBCore.Functions.GetPlayer(source)
