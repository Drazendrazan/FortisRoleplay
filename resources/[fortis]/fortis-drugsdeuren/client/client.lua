                            ...
                            if job == ("police") or job == ("ambulance") then
                                ...
                                if currentHours >= dealerUurMin and currentHours <= dealerUurMax then
                                    if missieStatus == false then
                                        ...
                                        TriggerServerEvent("fortis-drugsdeuren:server:geefBricks", missieBrickAmount)
                                        TriggerServerEvent("qb-phone:server:sendNewMail", {
                                            ...
                                            button = {
                                                enabled = true,
                                                buttonEvent = "fortis-drugsdeuren:client:setMissieLocatie",
...
RegisterNetEvent("fortis-drugsdeuren:client:setMissieLocatie")
AddEventHandler("fortis-drugsdeuren:client:setMissieLocatie", function(missieData)
                ...
                if missieDistance < 3 then
                    ...
                    if IsControlJustPressed(0, 38) then
                        if IsPedInAnyVehicle(missiePed, false) then
                            ...
                            QBCore.Functions.TriggerCallback("fortis-drugsdeuren:server:requestBrickAantal", function(aantal)
                                if aantal < missieData["aantal"] then
                                    ...
                                    QBCore.Functions.Progressbar("drugsdeuren", "Producten afleveren...", 5500, false, true, {
                                        ...
                                        TriggerServerEvent("fortis-drugsdeuren:server:missieAfleveren", missieData["aantal"])
