                ...
                if HasKey then
                    ...
                    if vehLockStatus == 1 then
                        ...
                        if(GetVehicleDoorLockStatus(veh) == 2)then
                            ...
                            QBCore.Functions.Notify("Er is iets fout gegaan met het slotensysteem!")
                        end
                    else
                        Citizen.Wait(750)
                        ClearPedTasks(GetPlayerPed(-1))
...
--                 QBCore.Functions.Progressbar("lockpick_vehicledoor", "Deur openen....", lockpickTime, false, true, {
...
--                         QBCore.Functions.Notify("Deur geopend!")
--                         TriggerServerEvent("InteractSound_SV:PlayWithinDistance", 5, "unlock", 0.3)
...
--                     openingDoor = false
--                     StopAnimTask(GetPlayerPed(-1), "veh@break_in@0h@p_m_one@", "low_force_entry_ds", 1.0)
--                     QBCore.Functions.Notify("slot!", "error")
--                     IsHotwiring = false
--                 end)
--             end
--         end
