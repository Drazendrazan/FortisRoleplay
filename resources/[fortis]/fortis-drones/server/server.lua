...
QBCore.Functions.CreateUseableItem("drone_1", function(source, item)
    ...
    TriggerClientEvent('fortis-drones:client:makeDrone', source, 1)
end)
...
QBCore.Functions.CreateUseableItem("drone_2", function(source, item)
    ...
    TriggerClientEvent('fortis-drones:client:makeDrone', source, 2)
end)
...
QBCore.Functions.CreateUseableItem("drone_3", function(source, item)
    ...
    TriggerClientEvent('fortis-drones:client:makeDrone', source, 3)
end)

RegisterServerEvent("fortis-drones:server:droneGebruiken")
AddEventHandler("fortis-drones:server:droneGebruiken", function(type)
    local src = source
    local Player = QBCore.Functions.GetPlayer(src)
...
RegisterServerEvent("fortis-drone:server:refundDrone")
AddEventHandler("fortis-drone:server:refundDrone", function(type)
    local src = source
    local Player = QBCore.Functions.GetPlayer(src)
...
RegisterServerEvent('fortis-drone:server:pickupDrone')
AddEventHandler('fortis-drone:server:pickupDrone', function()
    local src = source
    local Player = QBCore.Functions.GetPlayer(src)
...
RegisterServerEvent('fortis-drones:server:purchaseDrone')
AddEventHandler('fortis-drones:server:purchaseDrone', function(type)
    local src = source
    local Player = QBCore.Functions.GetPlayer(src)
