...
RegisterNetEvent("fortis-weathersync:client:regenUit")
AddEventHandler("fortis-weathersync:client:regenUit", function(status)
	if status then
		geenDruppels = true
	else
		geenDruppels = false
