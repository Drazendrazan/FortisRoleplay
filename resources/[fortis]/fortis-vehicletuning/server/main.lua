...
--         TriggerClientEvent("fortis-vehicletuning:client:SendEmergencyMessage", source, message)
...
RegisterServerEvent('fortis-vehicletuning:server:SendEmergencyMessage')
AddEventHandler('fortis-vehicletuning:server:SendEmergencyMessage', function(coords, message)
    local src = source
    local MainPlayer = QBCore.Functions.GetPlayer(src)
    ...
    TriggerClientEvent('fortis-vehicletuning:server:SendEmergencyMessageCheck', -1, MainPlayer, message, coords)
...
RegisterServerEvent('fortis-vehicletuning:server:SaveVehicleProps')
AddEventHandler('fortis-vehicletuning:server:SaveVehicleProps', function(vehicleProps)
    local src = source
