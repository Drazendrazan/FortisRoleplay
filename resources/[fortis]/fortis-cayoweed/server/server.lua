...
QBCore.Functions.CreateCallback("fortis-cayoweed:server:checkPlukken", function(source, cb)
    local src = source
...
RegisterNetEvent("fortis-cayoweed:server:krijgwiet")
AddEventHandler("fortis-cayoweed:server:krijgwiet", function()
    local src = source
    local Player = QBCore.Functions.GetPlayer(src)
...
QBCore.Functions.CreateCallback("fortis-cayoweed:server:checkSpullen", function(source, cb)
    local src = source
    local Player = QBCore.Functions.GetPlayer(src)
...
RegisterNetEvent("fortis-cayoweed:server:verpakWiet")
AddEventHandler("fortis-cayoweed:server:verpakWiet", function()
    local src = source
    local Player = QBCore.Functions.GetPlayer(src)
...
RegisterNetEvent("fortis-cayoweed:server:verpakFaal")
AddEventHandler("fortis-cayoweed:server:verpakFaal", function()
    local src = source
    local Player = QBCore.Functions.GetPlayer(src)
...
RegisterNetEvent("fortis-cayoweed:server:kauloHacker")
AddEventHandler("fortis-cayoweed:server:kauloHacker", function()
    local src = source
    ...
    DropPlayer(src, "Hacken binnen het Cayo Perico wiet script: https://fortisroleplay.nl/discord")
end)
...
QBCore.Functions.CreateCallback("fortis-cayoweed:server:checkDealer", function(source, cb)
    cb(locatie)
end)

RegisterNetEvent("fortis-cayoweed:server:verkoopWiet")
AddEventHandler("fortis-cayoweed:server:verkoopWiet", function()
    local src = source
    local Player = QBCore.Functions.GetPlayer(src)
    local totaal = 0
