...
RegisterServerEvent('fortis-huisoverval:server:betreedHuis')
AddEventHandler('fortis-huisoverval:server:betreedHuis', function(house)
    local src = source
    ...
    if not Config.Houses[house]["opened"] then
        ...
        TriggerClientEvent('fortis-huisoverval:client:zetHuisStatus', -1, house, true)
    end
    TriggerClientEvent('fortis-huisoverval:client:betreedOsso', src, house)
...
function ResetHouseStateTimer(house)
    ...
    Citizen.SetTimeout(time, function()
        ...
        TriggerClientEvent('fortis-huisoverval:client:ResetOssoStatus', -1, house)
    end)
end

RegisterServerEvent('fortis-huisoverval:server:zoekKasjeZebai')
AddEventHandler('fortis-huisoverval:server:zoekKasjeZebai', function(cabin, house)
    local src = source
    local Player = QBCore.Functions.GetPlayer(src)
    ...
    TriggerClientEvent('fortis-huisoverval:client:zetKasjeStatusOulleh', -1, house, cabin, true)
end)

RegisterServerEvent('fortis-huisoverval:server:zetKauloDrukStatus')
AddEventHandler('fortis-huisoverval:server:zetKauloDrukStatus', function(cabin, house, bool)
    Config.Houses[house]["furniture"][cabin]["isBusy"] = bool
    TriggerClientEvent('fortis-huisoverval:client:zetDrukkeOsso', -1, cabin, house, bool)
end)
