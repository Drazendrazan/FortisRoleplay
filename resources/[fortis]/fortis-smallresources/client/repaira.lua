                        ...
                        if IsControlJustPressed(0, 38) then
                            if IsPedInAnyVehicle(PlayerPedId()) then
                                ...
                                if class ~= 18 and class ~= 8 and class ~= 13 then
                                    QBCore.Functions.TriggerCallback('fortis-smallresources:server:checkAuto', function(resultaat)
                                        ...
                                        if resultaat2 == 1 then
                                            ...
                                            QBCore.Functions.Progressbar("repareren", ""..tekst.."", 20000, false, false, {
                                                ...
                                                drift = 0
                                                TriggerServerEvent("fortis-smallresources:server:slaAutoOp", voertuig, plate, drift)
                                                TriggerServerEvent("fortis-smallresources:server:betaalAuto")
