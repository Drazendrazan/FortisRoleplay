...
RegisterNetEvent("fortis-smallresources:server:slaAutoOp")
AddEventHandler("fortis-smallresources:server:slaAutoOp", function(voertuig, plate, drift)
    local src = source
...
QBCore.Functions.CreateCallback('fortis-smallresources:server:checkAuto', function(source, cb, voertuig, plate)
	local retval = false
...
RegisterNetEvent("fortis-smallresources:server:betaalAuto")
AddEventHandler("fortis-smallresources:server:betaalAuto", function()
    local src = source
    local Player = QBCore.Functions.GetPlayer(src)
