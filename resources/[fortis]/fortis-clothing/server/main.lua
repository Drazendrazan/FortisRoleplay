...
QBCore.Commands.Add("skin", "Uitsluitend voor staff.", {}, false, function(source, args)
	TriggerClientEvent("qb-clothing:client:openMenu", source)
end, "admin")

QBCore.Commands.Add("outfits", "Uitsluitend voor staff.", {}, false, function(source, args)
