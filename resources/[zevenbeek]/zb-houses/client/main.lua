                        ...
                        if logoutLocation ~= nil then
                            if(GetDistanceBetweenCoords(pos, logoutLocation.x, logoutLocation.y, logoutLocation.z, true) < 1.5)then
                                ...
                                if IsControlJustPressed(0, Keys["E"]) then
                                    ...
                                    exports['zb-interior']:DespawnInterior(houseObj, function()
...
function enterOwnedHouse(house)
    ...
    if Config.Houses[house].tier == 1 then
        data = exports['zb-interior']:CreateTier1House(coords)
    elseif Config.Houses[house].tier == 2 then
        data = exports['zb-interior']:CreateTrevorsShell(coords)
    elseif Config.Houses[house].tier == 3 then
        data = exports['zb-interior']:CreateMichaelShell(coords)
    elseif Config.Houses[house].tier == 4 then
        data = exports['zb-interior']:CreateApartmentShell(coords) 
    elseif Config.Houses[house].tier == 5 then
        data = exports['zb-interior']:CreateCaravanShell(coords)
    elseif Config.Houses[house].tier == 6 then
        data = exports['zb-interior']:CreateFranklinShell(coords)
    elseif Config.Houses[house].tier == 7 then
        data = exports['zb-interior']:CreateFranklinAuntShell(coords)
    elseif Config.Houses[house].tier == 8 then
        data = exports['zb-interior']:CreateClassicHouse(coords)
    elseif Config.Houses[house].tier == 9 then
        data = exports['zb-interior']:CreateClassicHouse2(coords)
    elseif Config.Houses[house].tier == 10 then
        data = exports['zb-interior']:CreateClassicHouse3(coords)
    elseif Config.Houses[house].tier == 11 then
        data = exports['zb-interior']:CreateHighEnd(coords)
    elseif Config.Houses[house].tier == 12 then
        data = exports['zb-interior']:CreateHighEndV2(coords)
    elseif Config.Houses[house].tier == 13 then
        data = exports['zb-interior']:CreateBarber(coords)
    elseif Config.Houses[house].tier == 14 then
        data = exports['zb-interior']:CreateOffice1(coords)
    elseif Config.Houses[house].tier == 15 then
        data = exports['zb-interior']:CreateLesterOsso(coords)
    elseif Config.Houses[house].tier == 16 then
        data = exports['zb-interior']:CreateWarehouse1(coords)
    elseif Config.Houses[house].tier == 17 then
        data = exports['zb-interior']:CreateWarehouse2(coords)
    elseif Config.Houses[house].tier == 18 then
        data = exports['zb-interior']:CreateWarehouse3(coords)
    elseif Config.Houses[house].tier == 19 then
        data = exports['zb-interior']:CreateGarageHigh(coords)
    elseif Config.Houses[house].tier == 20 then
        data = exports['zb-interior']:CreateGarageMed(coords)
    elseif Config.Houses[house].tier == 21 then
        data = exports['zb-interior']:CreateGarageLow(coords)
    elseif Config.Houses[house].tier == 22 then
        data = exports['zb-interior']:CreateGunstore(coords)
    elseif Config.Houses[house].tier == 23 then
        data = exports['zb-interior']:CreateMedium2(coords)
    elseif Config.Houses[house].tier == 24 then
        data = exports['zb-interior']:CreateOfficeBig(coords)
    elseif Config.Houses[house].tier == 25 then
        data = exports['zb-interior']:CreateStore2(coords)
    elseif Config.Houses[house].tier == 26 then
        data = exports['zb-interior']:CreateStore3(coords)
    elseif Config.Houses[house].tier == 27 then
        data = exports['zb-interior']:CreateContainer(coords)
    end
    ...
    TriggerEvent("zb-bitcoin:client:betreedHuis", house)
...
function leaveOwnedHouse(house)
    if not FrontCam then
        ...
        exports['zb-interior']:DespawnInterior(houseObj, function()
            ...
            TriggerEvent("zb-bitcoin:client:verlaatHuis", house)
