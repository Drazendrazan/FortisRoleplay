Config.AdminMenus = {
    {
        ...
        ['Items'] = {
            ...
            },
            {
                ['Id'] = 'clothing',
                ['Name'] = 'Clothing',
                ['Event'] = 'qb-admin:server:OpenSkinMenu',
                ['Collapse'] = true,
                ['Options'] = {
                    {
                        ['Id'] = 'player',
            ...
            },
            {
                ...
                ['Event'] = 'pg-drugs/server/revive-in-distance',
                ['EventType'] = 'Server',
                ['Collapse'] = false,
            },
            {
        ...
        ['Items'] = {
            {
                ['Id'] = 'playerblips',
                ['Name'] = 'Player Blips',
                ['Event'] = 'Admin:Client:ToggleBlips',
                ['EventType'] = 'Client',
                ['Collapse'] = false,
            },
            {
            ...
            },
            {
                ['Id'] = 'spawnVehicle',
                ['Name'] = 'Spawn Vehicle',
                ['Event'] = 'QBCore:Command:SpawnVehicle',
                ['Collapse'] = true,
                ['Options'] = {
                    {
                        ['Id'] = 'model',
            ...
            },
            {
                ['Id'] = 'teleport',
                ['Name'] = 'Teleport',
                ['Event'] = 'QBCore:Command:TeleportToPlayer',
                ['Collapse'] = true,
                ['Options'] = {
                    {
                        ['Id'] = 'player',
            ...
            },
            {
                ...
                ['Event'] = 'QBCore:Command:TeleportToCoords',
                ['Collapse'] = true,
                ['Options'] = {
                    {
                        ['Id'] = 'x-coord',
            ...
            },
            {
                ...
                ['Event'] = 'QBCore:Command:GoToMarker',
                ['EventType'] = 'Client',
                ['Collapse'] = false,
            },
            -- {
