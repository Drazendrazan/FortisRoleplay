...
function openHangar(hangar)
    ...
    QBCore.Functions.TriggerCallback("qb-garages:server:getVliegtuigen", function(result)
        ...
        if result == nil then
            ...
            for _ , v in pairs(result) do
                ...
                vliegtuigMenu[#vliegtuigMenu+1] = {
                    ...
                    params = {
                        event = "zb-garages:client:TakeOutvliegtuig",
                        args = {
                            vehicle = v,
                        }
                    }
        ...
        if shouldContinue then
            ...
            exports['zb-menu']:openMenu(vliegtuigMenu)
        end
    end, hangar)
end

RegisterNetEvent("zb-garages:client:TakeOutvliegtuig", function(vliegtuig)
    local vehicle = vliegtuig.vehicle
    haalUitGarage(vehicle)
end)

RegisterNetEvent("zb-garages:client:TakeOutDepotvliegtuig", function(vliegtuig)
    local vehicle = vliegtuig.vehicle
...
function openDepot()
    ...
    QBCore.Functions.TriggerCallback("qb-garages:server:getVliegtuigen", function(result)
        ...
        if result == nil then
            ...
            for _ , v in pairs(result) do
                ...
                vliegtuigDepotMenu[#vliegtuigDepotMenu+1] = {
                    ...
                    txt = "Brandstof: "..currentFuel.. "%",
                    params = { 
                        event = "zb-garages:client:TakeOutDepotvliegtuig",
                        args = {
                            vehicle = v,
                        }
                    }
        ...
        if shouldContinue then
            ...
            exports['zb-menu']:openMenu(vliegtuigDepotMenu)
        end
    end, "depot")
end
...
function haalUitGarage(vliegtuig)
    if vliegtuig.state == 1 then
        QBCore.Functions.SpawnVehicle(vliegtuig.plane, function(veh)
            ...
            QBCore.Functions.TriggerCallback("zb-garages:server:haalVliegtuigTuningsOp", function(properties)
