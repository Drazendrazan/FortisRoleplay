...
RegisterServerEvent('zb-garages:server:verscheep')
AddEventHandler('zb-garages:server:verscheep', function(plate)
...
QBCore.Functions.CreateCallback("zb-garages:server:haalVliegtuigTuningsOp", function(source, cb, kenteken)
    local src = source
    local properties = {}
