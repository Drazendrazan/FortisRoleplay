                        ...
                        if IsControlJustPressed(0, 38) then
                            ...
                            if typeActie == "verzamel" then -- Verzamel
                                QBCore.Functions.Progressbar("verzamel", "Pakketje verzamelen...", 5000, false, true, {
                                    ...
                                    TriggerServerEvent("zb-pakketpost:server:addPakketje")
                            ...
                            elseif typeActie == "verpak" then -- Verpak
                                QBCore.Functions.TriggerCallback("zb-pakketpost:server:requestPakketjesAantal", function(aantal)
                                    if aantal == 1 then
                                        QBCore.Functions.Progressbar("verpak", "Pakketje verpakken...", 5000, false, true, {
                                            ...
                                            QBCore.Functions.TriggerCallback("zb-pakketpost:server:requestPakketjesAantal", function(aantal)
                                                ...
                                                elseif aantal == 1 then
                                                    ...
                                                    TriggerServerEvent("zb-pakketpost:server:addVerpaktPakketje")
                                                end
                                            end)
                                        end, function() -- Actie geannuleerd
                                            QBCore.Functions.Notify("Je hebt de actie geannuleerd", "error")
                            ...
                            elseif typeActie == "bezorg" then -- Bezorg missie starten
                                QBCore.Functions.TriggerCallback("zb-pakketpost:server:requestVerpaktePakketjesAantal", function(aantalCode, aantal)
                                    ...
                                    elseif aantalCode == 1 then
                                        ...
                                        if missieStatus == false then -- Kijk of er al een missie gestart is
                                            ...
                                            TriggerServerEvent("zb-pakketpost:server:borg", true)
                                            TriggerEvent("zb-pakketpost:client:nieuweMissieLocatie", aantal)
                                ...
                                if missieStatus == true then
                                    if IsPedInAnyVehicle(ped, false) then
                                        ...
                                        if inleverVoertuig == GetHashKey("pakketpost") then
                                            ...
                                            TriggerServerEvent("zb-pakketpost:server:borg", false)
...
AddEventHandler("zb-pakketpost:client:nieuweMissieLocatie", function(aantal)
                ...
                if missieDistance < 4 then
                    ...
                    if IsControlJustPressed(0, 38) then
                        if IsPedInAnyVehicle(missiePed, false) then
                            ...
                            TriggerServerEvent("zb-pakketpost:server:missieBetaal")
                            -- Doe de rest
                            QBCore.Functions.TriggerCallback("zb-pakketpost:server:requestMissieVerpaktePakketjesAantal", function(aantal)
                                if aantal > 0 then
                                    RemoveBlip(MissieBlip)
                                    TriggerEvent("zb-pakketpost:client:nieuweMissieLocatie", 1)
                                else
