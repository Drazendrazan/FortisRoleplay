...
QBCore.Functions.CreateUseableItem("makelaarscontract", function(source, item)
    TriggerClientEvent("zb-huiscontract:client:useItem", source)
end)

verkopers = {}

QBCore.Functions.CreateCallback("zb-huiscontract:server:checkHuisOwner", function(source, cb, huis)
    local src = source
...
RegisterServerEvent("zb-huiscontract:server:geefContract")
AddEventHandler("zb-huiscontract:server:geefContract", function(target, bedrag, huis)
    local src = source
    local Player = QBCore.Functions.GetPlayer(src)
    ...
    TriggerClientEvent("zb-huiscontract:client:krijgContract", target, bedrag, huis)
end)

RegisterServerEvent("zb-huiscontract:server:koopHuis")
AddEventHandler("zb-huiscontract:server:koopHuis", function(bedrag, huis)
    local src = source
...
RegisterServerEvent("zb-huiscontract:server:koopcontract")
AddEventHandler("zb-huiscontract:server:koopcontract", function()
    local src = source
    local Player = QBCore.Functions.GetPlayer(src)
