...
AddEventHandler('apartments:server:CreateApartment', function(type, label)
    ...
    TriggerClientEvent('QBCore:Notify', src, "Je nieuwe appartement is ("..label..")")
    TriggerClientEvent("apartments:client:SpawnInApartment", src, apartmentId, type, true)
...
AddEventHandler('apartments:server:UpdateApartment', function(type)
    ...
    TriggerClientEvent('QBCore:Notify', src, "Je appartement is gewijzigd!")
    TriggerClientEvent("apartments:client:SetHomeBlip", src, type)
end)
