...
RegisterNetEvent('zb-lapraces:client:StartRaceEditor')
AddEventHandler('zb-lapraces:client:StartRaceEditor', function(RaceName)
    print(RaceName)
...
function SaveRace()
    ...
    TriggerServerEvent('zb-lapraces:server:SaveRace', CreatorData)
...
RegisterNetEvent('zb-lapraces:client:UpdateRaceRacerData')
AddEventHandler('zb-lapraces:client:UpdateRaceRacerData', function(RaceId, RaceData)
...
RegisterNetEvent('zb-lapraces:client:JoinRace')
AddEventHandler('zb-lapraces:client:JoinRace', function(Data, Laps)
    if not RaceData.InRace then
        RaceData.InRace = true
        SetupRace(Data, Laps)
        TriggerServerEvent('zb-lapraces:server:UpdateRaceState', CurrentRaceData.RaceId, false, true)
    else
        QBCore.Functions.Notify('Je bent al bezig met een race..', 'error')
    end
end)

RegisterNetEvent('zb-lapraces:client:LeaveRace')
AddEventHandler('zb-lapraces:client:LeaveRace', function(data)
...
RegisterNetEvent('zb-lapraces:client:RaceCountdown')
AddEventHandler('zb-lapraces:client:RaceCountdown', function()
    TriggerServerEvent('zb-lapraces:server:UpdateRaceState', CurrentRaceData.RaceId, true, false)
                ...
                if CheckpointDistance < MaxDistance then
                    if CurrentRaceData.TotalLaps == 0 then
                        if CurrentRaceData.CurrentCheckpoint + 1 < #CurrentRaceData.Checkpoints then
                            ...
                            SetNewWaypoint(CurrentRaceData.Checkpoints[CurrentRaceData.CurrentCheckpoint + 1].coords.x, CurrentRaceData.Checkpoints[CurrentRaceData.CurrentCheckpoint + 1].coords.y)
                            TriggerServerEvent('zb-lapraces:server:UpdateRacerData', CurrentRaceData.RaceId, CurrentRaceData.CurrentCheckpoint, CurrentRaceData.Lap, false)
                            DoPilePfx()
                            ...
                            PlaySound(-1, "SELECT", "HUD_FRONTEND_DEFAULT_SOUNDSET", 0, 0, 1)
                            CurrentRaceData.CurrentCheckpoint = CurrentRaceData.CurrentCheckpoint + 1
                            TriggerServerEvent('zb-lapraces:server:UpdateRacerData', CurrentRaceData.RaceId, CurrentRaceData.CurrentCheckpoint, CurrentRaceData.Lap, true)
                            FinishRace()
                        end
                    else
                        if CurrentRaceData.CurrentCheckpoint + 1 > #CurrentRaceData.Checkpoints then
...
function FinishRace()
    TriggerServerEvent('zb-lapraces:server:FinishPlayer', CurrentRaceData, CurrentRaceData.TotalTime, CurrentRaceData.TotalLaps, CurrentRaceData.BestLap)
...
RegisterNetEvent('zb-lapraces:client:PlayerFinishs')
AddEventHandler('zb-lapraces:client:PlayerFinishs', function(RaceId, Place, FinisherData)
    if CurrentRaceData.RaceId ~= nil then
...
RegisterNetEvent('zb-lapraces:client:WaitingDistanceCheck')
AddEventHandler('zb-lapraces:client:WaitingDistanceCheck', function()
    Wait(1000)
    Citizen.CreateThread(function()
        while true do
                ...
                if CurrentRaceData.Checkpoints[1] ~= nil then
                    ...
                    if dist > 115.0 then
                        if ToFarCountdown ~= 0 then
                            ...
                            TriggerServerEvent('zb-lapraces:server:LeaveRace', CurrentRaceData)
                            ToFarCountdown = 10
                            break
                        end
                        Citizen.Wait(1000)
