...
AddEventHandler('qb-spawn:client:openUI', function(value, new)
    ...
    Citizen.Wait(500)
	if new ~= nil then SetDisplay(value, true) else SetDisplay(value) end
end)
...
function SetDisplay(bool, new)
if new == nil then new = false end
    choosingSpawn = bool
