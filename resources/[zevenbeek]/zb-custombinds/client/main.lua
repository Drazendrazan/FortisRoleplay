...
RegisterNetEvent('zb-custombinds:client:openUI')
AddEventHandler('zb-custombinds:client:openUI', function()
    openBindingMenu()
end)
...
RegisterNUICallback('save', function(data)
    ...
    TriggerServerEvent('zb-custombinds:server:setKeyMeta', keyData)
end)