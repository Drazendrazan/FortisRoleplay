...
RegisterServerEvent("zb-fotograaf:server:addCamera")
AddEventHandler("zb-fotograaf:server:addCamera", function()
...
RegisterServerEvent("zb-fotograaf:server:addFoto")
AddEventHandler("zb-fotograaf:server:addFoto", function()
    local Player = QBCore.Functions.GetPlayer(source)
...
RegisterServerEvent("zb-fotograaf:server:removeCamera")
AddEventHandler("zb-fotograaf:server:removeCamera", function()
    local Player = QBCore.Functions.GetPlayer(source)
...
QBCore.Functions.CreateCallback("zb-fotograaf:server:requestCamera", function(source, cb)
    local Player = QBCore.Functions.GetPlayer(source)
...
QBCore.Functions.CreateCallback("zb-fotograaf:server:requestFotoAantal", function(source, cb)
    local Player = QBCore.Functions.GetPlayer(source)
