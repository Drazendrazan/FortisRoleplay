...
Config['PacificHeist'] = {
    ...
    ['rewardItems'] = { -- Add this items to database or shared. Don't change the order, you can change the item names. Also dont forget glass cutting and painting item names.(in bottom)
        {itemName = 'stolengoldbar', sellPrice = 2500},
        {itemName = 'diamond', sellPrice = 1000},
        {itemName = 'zakjemeth', sellPrice = 400},
    },
    ...
    ['startHeist'] ={ -- heist start coords
        pos = vector3(-2308.69, 249.18, 189.61), 
        peds = {
            {pos = vector3(-2308.69, 249.18, 189.61), heading = 70.23, ped = 's_m_m_highsec_01'},
            {pos = vector3(-2309.21, 250.38, 189.61), heading = 201.66, ped = 's_m_m_highsec_02'},
            {pos = vector3(-2310.16, 248.45, 189.61), heading = 292.29, ped = 's_m_m_fiboffice_02'}
        } 
    },
    ['finishHeist'] = {
        ...
        rewards = {
            {
                ...
                displayObj = {model = 'h4_prop_h4_neck_disp_01a', rot = vector3(360.0, 0.0, 70.0)},
                item = 'diamond_ring',
                price = 10000,
            },
            {
...
Strings = {
    ['start_heist'] = 'Ga naar de pacific bank!',
    ['start_heist2'] = 'Benodigdheden voor heist: Hack Laptop, Trojan USB, Slijptol, 6 x C4, 4 x Thermiet bom, Tas, Drillboor, Switchblade',
    ['plant'] = 'Druk op E om thermiet te plaatsen!',
    ['plant_bomb'] = 'Druk op E om c4 te plaatsen!',
    ['detonate_bombs'] = 'Press ~INPUT_CONTEXT~ to detonate bombs',
    ['grab'] = 'Druk op E om de spullen te pakken!',
    ['hacking'] = 'Druk op E om de trojan usb te gebruiken!',
    ['vault'] = 'Press ~INPUT_CONTEXT~ to open vault!',
    ['drill'] = 'Druk op E om de drill te gebruiken!',
    ['wait_nextrob'] = 'Je moet zolang wachten tot je nogmaals de heist kan starten',
    ['minute'] = 'minuten.',
    ['start_stealing'] = 'Druk op E om te stelen!',
    ...
    ['glass_cut'] = 'Druk op E om het glas te snijden!',
    ['need_switchblade'] = 'Je hebt een switchblade nodig!',
