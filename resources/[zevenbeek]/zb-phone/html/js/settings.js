...
$(document).on('click', '.settings-app-tab', function(e){
    ...
    if (PressedTab == "background") {
        ...
        if (checkStatus) { // Uit
            ...
            $.post('https://zb-phone/setTwitterGeluid', JSON.stringify({
                twitterGeluid: false
            }))
        } else { // Aan
...
$(document).on('click', '#accept-background', function(e){
    ...
    $.post('https://zb-phone/SetBackground', JSON.stringify({
...
$(document).on('click', '#accept-profilepicture', function(e){
    ...
    $.post('https://zb-phone/UpdateProfilePicture', JSON.stringify({
