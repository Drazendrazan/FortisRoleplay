...
$(document).on('click', '.twitter-header-tab', function(e){
    ...
    if (PressedTwitterTab !== CurrentTwitterTab) {
        ...
        if (PressedTwitterTab === "twitter-mentions") {
            $.post('https://zb-phone/ClearMentions');
        }
...
$(document).on('click', '#send-tweet', function(e){
    ...
    if (TweetMessage != "") {
        ...
        $.post('https://zb-phone/PostNewTweet', JSON.stringify({
...
$(document).on('click', '.hashtag-tag-text', function(e){
    ...
    if (!HashtagOpen) {
        ...
        $.post('https://zb-phone/GetHashtagMessages', JSON.stringify({hashtag: Hashtag}), function(HashtagData){
...
$(document).on('click', '.twitter-new-foto', function(e) {
    ...
    // e.preventDefault();
    // $.post("https://zb-phone/twitterMaakFoto", JSON.stringify({}));
