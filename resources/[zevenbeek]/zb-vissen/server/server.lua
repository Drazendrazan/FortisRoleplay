...
-- Hengel opvragen
QBCore.Functions.CreateCallback("zb-vissen:server:checkHengel", function(source, cb)
...
QBCore.Functions.CreateCallback("zb-vissen:server:vraagSpotAantal", function(source, cb, visspotNaam)
...
-- Visspot reservatie
RegisterServerEvent("zb-vissen:server:reserveerVisspot")
AddEventHandler("zb-vissen:server:reserveerVisspot", function(visspotNaam)
    local visspotNaam = visspotNaam
    ...
    if visspotNaam == "paletocove" then
        if not paletocoveSpot1 then
            ...
            TriggerClientEvent("zb-vissen:server:startVissen", source, 1, 2)
        ...
        if not paletocoveSpot2 then
            ...
            TriggerClientEvent("zb-vissen:server:startVissen", source, 1, 3)
        ...
        if not paletocoveSpot3 then
            ...
            TriggerClientEvent("zb-vissen:server:startVissen", source, 1, 4)
    ...
    elseif visspotNaam == "kanaalstad" then
        if not kanaalstad1 then
            ...
            kanaalstad1 = true
            TriggerClientEvent("zb-vissen:server:startVissen", source, 2, 2)
        ...
        if not kanaalstad2 then
            kanaalstad = kanaalstad + 1
            kanaalstad2 = true
            TriggerClientEvent("zb-vissen:server:startVissen", source, 2, 3)
        ...
        if not kanaalstad3 then
            kanaalstad = kanaalstad + 1
            kanaalstad3 = true
            TriggerClientEvent("zb-vissen:server:startVissen", source, 2, 4)
    ...
    elseif visspotNaam == "vinewood" then
        if not vinewood1 then
            vinewood = vinewood + 1
            vinewood1 = true
            TriggerClientEvent("zb-vissen:server:startVissen", source, 3, 2)
        ...
        if not vinewood2 then
            vinewood = vinewood + 1
            vinewood2 = true
            TriggerClientEvent("zb-vissen:server:startVissen", source, 3, 3)
        ...
        if not vinewood3 then
            vinewood = vinewood + 1
            vinewood3 = true
            TriggerClientEvent("zb-vissen:server:startVissen", source, 3, 4)
    ...
    elseif visspotNaam == "cayo" then
        if not cayo1 then
            cayo = cayo + 1
            cayo1 = true
            TriggerClientEvent("zb-vissen:server:startVissen", source, 4, 2)
        ...
        if not cayo2 then
            cayo = cayo + 1
            cayo2 = true
            TriggerClientEvent("zb-vissen:server:startVissen", source, 4, 3)
        ...
        if not cayo3 then
            cayo = cayo + 1
            cayo3 = true
            TriggerClientEvent("zb-vissen:server:startVissen", source, 4, 4)
...
RegisterServerEvent("zb-vissen:server:verwijderVisspot")
AddEventHandler("zb-vissen:server:verwijderVisspot", function(visspot, verwijderSpotNummer)
    local steam = GetPlayerIdentifiers(source)[1]
...
RegisterServerEvent("zb-vissen:server:geefVis")
AddEventHandler("zb-vissen:server:geefVis", function()
    local Player = QBCore.Functions.GetPlayer(source)
...
-- Verkoop die vissen
RegisterServerEvent("zb-vissen:server:verkoopVissen")
AddEventHandler("zb-vissen:server:verkoopVissen", function()
    local Player = QBCore.Functions.GetPlayer(source)
    local src = source
    local bedrag = 0
