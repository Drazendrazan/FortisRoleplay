...
Config.Locations = {
    ["vehicle"] = {
        label = "Missie voertuig inleveren",
        coords = {x = -350.91, y = -144.31, z = 39.0},
    },
    ["towspots"] = {
...
Config.Vooraad = {
    [1] = {x = -355.64, y = -84.73, z = 39.01},
    [2] = {x = -312.11, y = -117.13, z = 39.05},
}
...
Language = {
	...
	['en'] = {
		...
		['elevator_stop'] = "Stop the elevator", 
	  	...
	  	['delete_elevator'] = "DEBUG: Delete props before restart",
	},
