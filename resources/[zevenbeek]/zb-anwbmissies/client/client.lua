...
--trailer
RegisterNetEvent('zb-anwbmissies:client:trailer')
AddEventHandler('zb-anwbmissies:client:trailer', function()
...
RegisterNetEvent("zb-anwbmissies:client:stopmotor")
AddEventHandler("zb-anwbmissies:client:stopmotor", function()
...
function Tunerchippakken()
    closeMenuFull()
    TriggerServerEvent("zb-anwbmissies:server:geeftunerofnitro", "tunerlaptop")
...
function Nitropakken() 
    closeMenuFull()
    TriggerServerEvent("zb-anwbmissies:server:geeftunerofnitro", "nitrous")
...
function Standaarduitrusting()
    closeMenuFull()
    TriggerServerEvent("zb-anwbmissies:server:geefuitrusting")
...
function pakturbo()
    ...
    while true do
        ...
        if IsControlJustPressed(0, 38) then
            ...
            QBCore.Functions.TriggerCallback("zb-anwbmissies:server:check", function(resultaat)
                print(resultaat)
                        ...
                        if GetDistanceBetweenCoords(curVehLocatie, pedPos, true) < 4 then
                            ...
                            if mogelijk then
                                QBCore.Functions.Progressbar("reful_boat", ""..titlevar.."", 1000, false, false, {
                                    ...
                                    TriggerServerEvent('zb-anwbmissies:server:updateVehicleStatus', kenteken,  props)
                                    ClearPedTasksImmediately(PlayerPedId())
