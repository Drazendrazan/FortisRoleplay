...
Citizen.CreateThread(function()
    while true do
        ...
        TriggerClientEvent("zb-scoreboard:client:updateScoreboard", -1, scoreboardData)
    end
end)

QBCore.Functions.CreateCallback("zb-scoreboard:server:haalEersteDataOp", function(source, cb)
    local cbTabelletje = {}
