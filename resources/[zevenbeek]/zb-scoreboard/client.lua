...
AddEventHandler('QBCore:Client:OnPlayerLoaded', function()
    ...
    QBCore.Functions.TriggerCallback("zb-scoreboard:server:haalEersteDataOp", function(cbData)
...
RegisterNetEvent("zb-scoreboard:client:updateScoreboard")
AddEventHandler("zb-scoreboard:client:updateScoreboard", function(tmpscoreboardData)
...
RegisterNetEvent("zb-scoreboard:client:openScoreboard")
AddEventHandler("zb-scoreboard:client:openScoreboard", function()
    if not scoreboardOpen and scoreboardData ~= nil then
        PlayerOptin = scoreboardData["playerList"]
        Config.CurrentCops = scoreboardData["hulpdiensten"]["police"]
        SendNUIMessage({
