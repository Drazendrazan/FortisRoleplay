    ...
    while true do
        ...
        if oppakkenMogelijk == false then
            if AreaDistance < 100 then
                ...
                TriggerEvent("zb-diving:client:krijgLocatie")
                Citizen.Wait(500)
            end
        else
            Citizen.Wait(2500)
    ...
    while true do
        ...
        if verkoopDistance <= 2 then
            ...
            if IsControlJustPressed(0, 38) then
                QBCore.Functions.TriggerCallback("zb-duiken:server:requestOnderwatervondst", function(onderwatervondstAantal)
                    if onderwatervondstAantal >= 1 then
                        TriggerServerEvent('zb-duiken:server:verkopen')
                    else
...
AddEventHandler("zb-diving:client:krijgLocatie", function()
