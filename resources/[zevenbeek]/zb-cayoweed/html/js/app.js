        ...
        stage(aantal) {
            ...
            if (aantal == 1 && !this.disabled1) {
                ...
                setTimeout(() => {
                    ...
                    this.plukken2 = false;
                    this.show = false;
                    $.post("https://zb-cayoweed/plukGeslaagd", JSON.stringify({}));
                }, 1000);
            }
        },
        ...
        kaas() {
            if (this.zipValue == 100) {
                ...
                if (tijdNu >= this.zipStartTijd + 1300) {
                    ...
                    this.zipStartTijd = 0;
                    $.post("https://zb-cayoweed/verpakGeslaagd", JSON.stringify({}));
                } else {
                    this.verpakken = false,
                    this.show = false,
                    this.zipValue = 0;
                    this.verpakWietje = false;
                    this.zipStartTijd = 0;
                    $.post("https://zb-cayoweed/verpakGefaald", JSON.stringify({
                        reden: 1
                    }));
                }
            }
