...
RegisterNetEvent("zb-luxury:client:verkoopAuto")
AddEventHandler("zb-luxury:client:verkoopAuto", function(tier, verkoperID)
...
RegisterNetEvent("zb-luxury:client:verkoopHeli")
AddEventHandler("zb-luxury:client:verkoopHeli", function(tier, verkoperID)
...
RegisterNUICallback("bevestigen", function(data, cb)
    ...
    QBCore.Functions.TriggerCallback('zb-luxury:server:koopVoertuig', function(resultaat, kenteken)
        if resultaat then
            TriggerServerEvent("zb-luxury:server:notifyVerkoperSucces", verkoperID)
            ...
            TriggerServerEvent("zb-luxury:server:notifyVerkoperFout", verkoperID)
        end
    end, tier)
