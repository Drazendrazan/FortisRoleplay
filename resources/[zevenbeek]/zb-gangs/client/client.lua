...
AddEventHandler('QBCore:Client:OnPlayerLoaded', function()
    QBCore.Functions.TriggerCallback("zb-gangs:server:vraagGang", function(status, naam)
        if status then
            gang = naam
        end
    end)
...
Citizen.CreateThread(function()
    ...
    while true do
        ...
        if gang ~= false then
            ...
            --                     if not bezig then
            --                         QBCore.Functions.TriggerCallback("zb-gangs:server:checkGeld", function(resultaat)
            --                             if resultaat then
            --                                 bezig = true
