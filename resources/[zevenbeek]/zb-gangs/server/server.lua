...
QBCore.Functions.CreateCallback("zb-gangs:server:vraagGang", function(source, cb)
    local src = source
...
-- QBCore.Functions.CreateCallback("zb-gangs:server:checkGeld", function(source, cb)
