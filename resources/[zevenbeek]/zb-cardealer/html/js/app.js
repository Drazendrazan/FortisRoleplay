window.addEventListener("message", function(event) {
    if (event.data.type == "open") {
        ...
        $.post("https://zb-cardealer/sluiten", JSON.stringify({}));
...
const app = {
    ...
    methods: {
        ...
        openHome() {
            ...
            $.post("https://zb-cardealer/verwijderVoertuig", JSON.stringify({}));
            $("#cardealerinfo").slideUp(500);
            this.resetScroller();
        },
        ...
        previewVoertuig(voertuig, keyIndex) {
            ...
            $.post("https://zb-cardealer/previewVoertuig", JSON.stringify({
                voertuig: voertuig
            }));
        ...
        proefrit() {
            ...
            $.post("https://zb-cardealer/proefrit", JSON.stringify({
        ...
        kopen() {
            ...
            $.post("https://zb-cardealer/kopen", JSON.stringify({
                voertuig: this.currentVoeruig,
