...
RegisterNetEvent('zb-vehicletuning:client:SendEmergencyMessage')
AddEventHandler('zb-vehicletuning:client:SendEmergencyMessage', function(message)
    local coords = GetEntityCoords(GetPlayerPed(-1))
    TriggerServerEvent("zb-vehicletuning:server:SendEmergencyMessage", coords, message)
    TriggerEvent("police:client:CallAnim")
end)

RegisterNetEvent('zb-vehicletuning:server:SendEmergencyMessageCheck')
AddEventHandler('zb-vehicletuning:server:SendEmergencyMessageCheck', function(MainPlayer, message, coords)
...
RegisterNetEvent('zb-vehicletuning:client:impoundveh')
AddEventHandler('zb-vehicletuning:client:impoundveh', function()
	QBCore.Functions.GetPlayerData(function(PlayerData)
		PlayerJob = PlayerData.job
        if PlayerData.job.name == "mechanic" then
            if PlayerData.job.onduty then
...
function VehicleList()
    ...
    for _ , v in pairs(Config.Vehicles) do
        ...
        anwbGarage[#anwbGarage+1] = {
            ...
            txt = "",
            params = {
                event = "zb-vehicletuning:client:TakeOutGarageVehicle",
                args = {
                    vehicle = _,
                }
            }
    ...
    if shouldContinue then
        ...
        exports['zb-menu']:openMenu(anwbGarage)
    end
end

RegisterNetEvent("zb-vehicletuning:client:TakeOutGarageVehicle", function(vehicledata)
