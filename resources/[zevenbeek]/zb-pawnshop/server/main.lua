...
QBCore.Functions.CreateCallback('zb-pawnshop:server:checksiraden', function(source, cb)
    local src = source
...
RegisterServerEvent("zb-pawnshop:sever:geefgoud")
AddEventHandler("zb-pawnshop:sever:geefgoud", function()
    local src = source
    local Player = QBCore.Functions.GetPlayer(src)
