...
<div class="row">
    ...
    <div class="col-lg-8  warrant-report">
        ...
        <form method="post">
            ...
            <div class="form-group">
                <button type="submit" style="margin-top: 1vh; float: right;" name="create" class="btn btn-danger"><?php echo $war_remove;?></button>
            </div>
        </form>
    </div>
        <?php } else { ?>
    <div class="content-introduction">
        ...
        <!-- <input type="hidden" name="type" value="create"> -->
            <div class="form-group">
                <button type="submit" style="margin-top: 1vh; float: right;" class="btn btn-success btn-md my-0 ml-sm-2 w-100"><?php echo $war_new;?></button>
            </div>
        </form>
    </div>
        <?php } ?>
