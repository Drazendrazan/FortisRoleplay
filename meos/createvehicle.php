...
?>
        ...
        <main role="main" class="container">
            <div class="content-introduction">
                <h3><?php echo $cv_head; ?></h3>
                <p class="lead"><?php echo $cv_info; ?></p>
            </div>
            <div class="createprofile-container">
                <div class="createprofile-left">
                <?php if ($_SERVER['REQUEST_METHOD'] == "GET" && $_GET['type'] == "edit") { ?>
                    <form method="POST">
                        <input type="hidden" name="type" value="realedit">
                        <input type="hidden" name="vehicleid" value="<?php echo $vehicleid; ?>">
                        <div class="input-group mb-3">
                            <input type="text" name="note" class="form-control login-user" value="<?php echo $note; ?>" placeholder="Note...">
                        </div>
                        ...
                        <div class="form-group">
                            <button type="submit" class="btn btn-primary btn-police"><?php echo $cv_save; ?></button>
                        </div>
                    </form>
                <?php } ?>
                </div>
